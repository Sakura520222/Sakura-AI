...
- **PR 创建闭环**：支持 AI 生成 Conventional Commits 风格 PR 标题、创建普通或 Draft PR，并通过 Sakura PR 审查与人工反馈继续迭代；不会自动合并 PR
